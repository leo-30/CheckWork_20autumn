...
//    }
    ...
    @IBAction func save() {
        ...
        saveData.set(dateField.text, forKey: "date")
        saveData.set(titleField.text, forKey: "title")
...
//        }
        ...
        if saveData.object(forKey: "date") != nil {
            dateField.text = saveData.object(forKey: "date") as? String
        } else {
            dateField.text = ""
        }
        
        if saveData.object(forKey: "title") != nil {
            titleField.text = saveData.object(forKey: "title") as? String
        } else {
            titleField.text = ""
        }
